...
/** getChartByAi POST /api/chart/create */
export async function getChartByAiUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/create', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsync POST /api/chart/create/async */
export async function genChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/create/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncMq POST /api/chart/create/async/mq */
export async function genChartByAiAsyncMqUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/create/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
